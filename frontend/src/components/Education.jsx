        ...
        <div className="space-y-5">
          {educationList.map((edu) => (
            <div
              ...
              className="p-7 rounded-2xl bg-white/[0.06] backdrop-blur-[8px] border border-white/[0.12] hover:border-cyan-500/30 transition-all duration-300 shadow-xl flex flex-col sm:flex-row sm:items-center justify-between gap-4 group"
            >
