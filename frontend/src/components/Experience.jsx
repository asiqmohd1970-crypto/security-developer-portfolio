          ...
          {experiences.map((exp) => {
            ...
            return (
              <div
                ...
                className="p-8 rounded-2xl bg-white/[0.06] backdrop-blur-[8px] border border-white/[0.12] hover:border-cyan-500/30 transition-all duration-300 shadow-xl group"
              >
