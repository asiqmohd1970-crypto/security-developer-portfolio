        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {projects.map((project) => {
            ...
            return (
              <div
                key={project.title}
                className="flex flex-col justify-between p-8 rounded-2xl bg-white/[0.06] backdrop-blur-[8px] border border-white/[0.12] hover:border-cyan-500/40 transition-all duration-300 shadow-xl group"
              >
                <div>
